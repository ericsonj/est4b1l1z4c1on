...
CREATE TABLE inventory_partial_inventory(
     ...
     desktop_inventory_admin_warehouse  INT /*REFERENCES inventory_admin_warehouse(id)*/,
     internal_location   INT,
...
ALTER TABLE inventory_partial_inventory
ADD CONSTRAINT FK_inventory_partial_inventory_1
FOREIGN KEY (desktop_inventory) REFERENCES inventory( id ) ON DELETE RESTRICT;

ALTER TABLE inventory_partial_inventory
ADD CONSTRAINT FK_inventory_partial_inventory_2
FOREIGN KEY (desktop_inventory_admin_warehouse) REFERENCES inventory_admin_warehouse( id ) ON DELETE RESTRICT;
